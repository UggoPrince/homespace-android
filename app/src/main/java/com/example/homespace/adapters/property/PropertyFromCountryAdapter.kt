...
class PropertyFromCountryAdapter :
    PagingDataAdapter<Property, PropertyFromCountryAdapter.ViewHolder>(PROPERTY_COMPARATOR) {
    ...
    companion object {
        private val PROPERTY_COMPARATOR = PropertyFromCountryComparator
    }
}